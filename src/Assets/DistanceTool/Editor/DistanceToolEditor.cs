...
public class DistanceToolEditor : Editor
{
  ...
  public override void OnInspectorGUI()
  {
    ...
    EditorGUILayout.Separator();
    _target.startPoint = EditorGUILayout.Vector3Field("Start Point", _target.startPoint, GUILayout.ExpandWidth(true));
    _target.endPoint = EditorGUILayout.Vector3Field("End Point", _target.endPoint, GUILayout.ExpandWidth(true));
    EditorGUILayout.Separator();
