...
{
  public class GhostStoryJumpControlledDisappearingPlatformFactory : JumpControlledDisappearingPlatformFactory
  {
    public GhostStoryJumpControlledDisappearingPlatformFactory(
      GameObject root,
      Map map,
