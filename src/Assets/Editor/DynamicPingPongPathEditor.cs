...
[CustomEditor(typeof(DynamicPingPongPath))]
public class DynamicPingPongPathEditor : Editor
{
  private GUIStyle _style = new GUIStyle();

  private DynamicPingPongPath _target;
  ...
  void OnEnable()
  {
    ...
    _target = (DynamicPingPongPath)target;
  }
